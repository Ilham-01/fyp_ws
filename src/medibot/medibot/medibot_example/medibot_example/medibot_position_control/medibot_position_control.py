...
from medibot_example.medibot_position_control.medibot_path import MedibotPath

terminal_msg = """
Medibot Position Control
------------------------------------------------------
...
class MedibotPositionControl(Node):

    def __init__(self):
        super().__init__('medibot_position_control')
        ...
        ************************************************************"""
        ...
        self.get_logger().info("Medibot position control node has been initialised.")
    ...
    def generate_path(self):
        ...
        if self.get_key_state is False:
            ...
            if self.step == 1:
                ...
                twist, self.step = MedibotPath.turn(angle, angular_velocity, self.step)
            ...
            # Step 2: Go Straight
                ...
                twist, self.step = MedibotPath.go_straight(distance, linear_velocity, self.step)
